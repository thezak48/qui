...
export const themes: Theme[] = [
  {
    ...
    cssVars: {
      light: {
        "--background": "oklch(0.9868 0.0050 271.5478)",
        "--foreground": "oklch(0.1019 0.0217 264.5206)",
        "--card": "oklch(0.9868 0.0050 271.5478)",
        "--card-foreground": "oklch(0.1019 0.0217 264.5206)",
        "--popover": "oklch(0.9868 0.0050 271.5478)",
        "--popover-foreground": "oklch(0.1019 0.0217 264.5206)",
        "--primary": "oklch(0.3608 0.1217 265.8085)",
        "--primary-foreground": "oklch(0.9868 0.0050 271.5478)",
        "--secondary": "oklch(0.9335 0.0087 264.5206)",
        "--secondary-foreground": "oklch(0.1019 0.0217 264.5206)",
        "--muted": "oklch(0.9335 0.0087 264.5206)",
        "--muted-foreground": "oklch(0.5333 0.0319 264.5208)",
        "--accent": "oklch(0.9335 0.0087 264.5206)",
        "--accent-foreground": "oklch(0.1019 0.0217 264.5206)",
        "--destructive": "oklch(0.5912 0.2066 27.3248)",
        "--destructive-foreground": "oklch(0.9868 0.0050 271.5478)",
        "--border": "oklch(0.8703 0.0174 264.5206)",
        ...
        "--sidebar-primary": "oklch(0.1019 0.0217 264.5206)",
        "--sidebar-primary-foreground": "oklch(0.9868 0.0050 271.5478)",
        "--sidebar-accent": "oklch(0.9553 0.0050 271.5478)",
        "--sidebar-accent-foreground": "oklch(0.1019 0.0217 264.5206)",
        "--sidebar-border": "oklch(0.8703 0.0174 264.5206)",
        "--sidebar-ring": "oklch(0.5547 0.2503 297.0156)",
      },
      dark: {
        "--background": "oklch(0.1683 0.0217 264.5206)",
        "--foreground": "oklch(0.9868 0.0050 271.5478)",
        "--card": "oklch(0.1683 0.0217 264.5206)",
        "--card-foreground": "oklch(0.9868 0.0050 271.5478)",
        "--popover": "oklch(0.1683 0.0217 264.5206)",
        "--popover-foreground": "oklch(0.9868 0.0050 271.5478)",
        "--primary": "oklch(0.8787 0.0426 272.2767)",
        "--primary-foreground": "oklch(0.1019 0.0217 264.5206)",
        "--secondary": "oklch(0.2348 0.0303 264.5206)",
        "--secondary-foreground": "oklch(0.9868 0.0050 271.5478)",
        "--muted": "oklch(0.2348 0.0303 264.5206)",
        "--muted-foreground": "oklch(0.6358 0.0319 264.5208)",
        "--accent": "oklch(0.2348 0.0303 264.5206)",
        "--accent-foreground": "oklch(0.9868 0.0050 271.5478)",
        "--destructive": "oklch(0.6543 0.2537 29.2339)",
        "--destructive-foreground": "oklch(0.9868 0.0050 271.5478)",
        "--border": "oklch(0.2348 0.0303 264.5206)",
        ...
        "--sidebar-primary": "oklch(0.9868 0.0050 271.5478)",
        "--sidebar-primary-foreground": "oklch(0.1019 0.0217 264.5206)",
        "--sidebar-accent": "oklch(0.2053 0.0277 265.9552)",
        "--sidebar-accent-foreground": "oklch(0.8787 0.0426 272.2767)",
        "--sidebar-border": "oklch(0.2348 0.0303 264.5206)",
